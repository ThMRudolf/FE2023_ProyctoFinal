...
*Pruebe de Hipothesis: Definicion*
H0: La proporcion en el condado es igual a la de la popalcion completa de Illenois.

H1: La proporcion en el condado es menor a la de la popalcion completa de Illenois.

Vamos a hacer una pruebe de Wald porque estmos comparando dos proporciones.
```{r}
# sample size
N = 310
# successes in %
...
(result)
```
*Respuesta*: el valor p es 0.004 lo que nos lleva a la conclucion que no hay suficiente prueba para la H0 y la suspecha del investigador es correcto.
